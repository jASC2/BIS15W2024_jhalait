...
```{r}
life_history <- read_csv("data/mammal_lifehistories_v3.csv", na=c("NA", " ", ".", "-999", "not measured")) %>% clean_names() #this will replace the values within the vector with NA, whenever the computer comes across them in the data frame. For this to work, you need to know how the NAs are represented in the data, meaning you do not want to do this by default.
```
