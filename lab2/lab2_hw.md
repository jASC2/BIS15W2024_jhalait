...
A vector is a way to organize data into essentially a list of distinct values.

2. What is a data matrix in R?  

A data matrix is an alternate way to organize data into essentially a table with rows and values. In this way, a matrix is a more informative format, as these rows and columns can be assigned labels. Here, each row can be considered a vector in itself.
