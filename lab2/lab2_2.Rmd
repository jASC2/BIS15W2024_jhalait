...
Adding a colon `:` selects the specified elements in a column. Here '1:4' implies items 1 - 4, beginning at the first column and moving down. '9:12' will give you the first four values from column 2.
```{r}
harry_potter_matrix[1:4]
harry_potter_matrix[9:12]
```

We can also select values in an entire row or column. This can be useful for calculations. Here we calculate the mean of the entire second column. [rows, columns]
```{r}
non_us_earnings <- all_harry_potter_matrix[ ,2]
Goblet_of_Fire_Mean <- all_harry_potter_matrix[4,] #assigns the object row 4
Goblet_of_Fire_Mean <- all_harry_potter_matrix[4] #assigns the object the value at [1,4]
